...
public class addressbook {
	...
	public static void main(String[] args) {
		...
		while (choice < 9) {
			...
			System.out.println("\nEnter your Option " + "1.Add Contact " + " 2.PrintContact "
					+ "  3.Edit Contact " + "  4.Delete Contact" + "  5. Sorting by First Name"
					+ "  6. Sorting by City Name" + "  7. View Cities and State of Contacts "
					+ "  8. Search contacts in Cities and States " + "  9. Exit from menu : ");
			choice = scan.nextInt();
			switch (choice) {
			case 1:
				contact.addPerson();
	...
	public void addPerson() {
		System.out.println("Enter Details for storing contacts");
	...
	public void searchContact() {
		int choice;
		String city, state;
		System.out.println("  1.Search Contact in cities :" + "  2. Search Contacts in State ");
		choice = scan.nextInt();
		if (choice == ONE) {
